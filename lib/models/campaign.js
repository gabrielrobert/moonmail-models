    ...
    value: function cancelSchedule(userId, campaignId) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var params = {
          ...
          Key: _this4._buildKey(userId, campaignId),
        ...
        return _this4._client('update', params).then(function (result) {
    ...
    value: function scheduledInPast() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var params = {
          ...
          IndexName: _this5.scheduledAtIndex,
        ...
        return _this5._client('scan', params).then(function (result) {
