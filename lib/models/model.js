...
var Model = function () {
  ...
  _createClass(Model, null, [{
    ...
    key: '_buildOptions',
    value: function _buildOptions(options, params) {
      ...
      (0, _deepAssign2.default)(fieldsOptions, pageOptions);
      var limitOptions = this._buildLimitOptions(options, fieldsOptions);
      (0, _deepAssign2.default)(fieldsOptions, limitOptions);
    ...
    value: function allBy(key, value) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var dbOptions = _this5._buildOptions(options, params);
