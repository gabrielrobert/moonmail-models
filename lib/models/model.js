...
var Model = function () {
  ...
  _createClass(Model, null, [{
    ...
    key: 'update',
    value: function update(params, key, range) {
      var _this2 = this;

      return new Promise(function (resolve, reject) {
        (0, _logger.debug)('= Model.update', key);
        var dbParams = {
          TableName: _this2.tableName,
          Key: _this2._buildKey(key, range),
    ...
    value: function allBy(key, value) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (options.nextPage) {
          params.ExclusiveStartKey = _this3.lastEvaluatedKey(options.nextPage);
        }
        _this3._client('query', params).then(function (result) {
          if (result.LastEvaluatedKey) {
            resolve({
              Items: result.Items,
              nextPage: _this3.nextPage(result.LastEvaluatedKey)
            });
          } else {
    ...
    value: function _client(method, params) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this4._db()[method](params, function (err, data) {
          if (err) {
