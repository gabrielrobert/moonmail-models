  ...
  _createClass(Model, null, [{
    ...
    value: function get(key, range) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        params.Key[_this.hashKey] = key;
        if (range) {
          params.Key[_this.rangeKey] = range;
        }
    ...
    value: function allBy(key, value) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (options.nextPage) {
          params.ExclusiveStartKey = _this2.lastEvaluatedKey(options.nextPage);
        }
        _this2._client('query', params).then(function (result) {
          if (result.LastEvaluatedKey) {
            resolve({
              Items: result.Items,
              nextPage: _this2.nextPage(result.LastEvaluatedKey)
            });
          } else {
    ...
    value: function _client(method, params) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this3._db()[method](params, function (err, data) {
          if (err) {
