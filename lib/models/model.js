  ...
  _createClass(Model, null, [{
        ...
        (function () {
          ...
          Object.keys(options.filters).forEach(function (key) {
            ...
            Object.keys(conditions).forEach(function (operand) {
              ...
              filterExpressions.push(_this3._buildFilter(attrName, attrValue, operand));
            });
          });
    ...
    value: function allBy(key, value) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var params = {
          ...
          ScanIndexForward: _this7.scanForward
        };
        var keyParams = _this7._buildKeyParams(value, options);
        var dbOptions = _this7._buildOptions(options, params);
        (0, _deepAssign2.default)(params, keyParams, dbOptions);
    ...
    value: function _buildRangeKeyParams(options) {
      if (options.range) {
        ...
        var keyCondition = this._buildFilter('#rkey', ':rvalue', operand);
    ...
    value: function allBetween(hash, rangeStart, rangeEnd) {
      ...
      return this._client('query', params).then(function (result) {
        return _this8._buildResponse(result);
      });
    }
  }, {
    key: '_buildResponse',
    ...
    value: function _buildNextKey(lastItem) {
      ...
      var lastKey = this._buildItemKey(lastItem);
    ...
    value: function _buildPrevKey(firstItem) {
      ...
      var firstItemKey = this._buildItemKey(firstItem);
    ...
    value: function countBy(key, value) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this9._client('query', params).then(function (result) {
    ...
    value: function _client(method, params) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this10._db()[method](params, function (err, data) {
          if (err) {
            (0, _logger.debug)('= Model._client', method, 'Error', err);
            reject(err);
          } else {
            (0, _logger.debug)('= Model._client', method, 'Success');
            if (data.UnprocessedItems && Object.keys(data.UnprocessedItems).length > 0 && retries < _this10.maxRetries) {
              (function () {
                ...
                var delay = _this10.retryDelay * Math.pow(2, retries);
                setTimeout(function () {
                  resolve(_this10._client(method, retryParams, retries + 1));
                }, delay);
              })();
            } else {
