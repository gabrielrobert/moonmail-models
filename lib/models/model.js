      ...
      return new Promise(function (resolve, reject) {
        ...
        _this5._db()[method](params, function (err, data) {
          if (err) {
            ...
            if (data.UnprocessedItems && Object.keys(data.UnprocessedItems).length > 0 && retries < _this5.maxRetries) {
              (function () {
                ...
                var delay = _this5.retryDelay * Math.pow(2, retries);
                setTimeout(function () {
                  resolve(_this5._client(method, retryParams, retries + 1));
                }, delay);
              })();
            } else {
